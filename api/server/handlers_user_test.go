...
func TestServer_CreateUser(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			srv.CreateUser(w, httptest.NewRequest(http.MethodPost, "/test", strings.NewReader(tt.requestJSON)))
			response := w.Result()
...
func TestServer_LoginUser(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			srv.LoginUser(w, httptest.NewRequest(http.MethodPost, "/test", strings.NewReader(tt.requestJSON)))
			response := w.Result()
